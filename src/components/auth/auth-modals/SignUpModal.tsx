...
const SignUpModal: React.FC<SignUpModalProps> = ({ onClose, setPopupType }) => {
    ...
    return (
        <div className="popup-body">
            ...
            <form onSubmit={(e: FormEvent) => handleSubmit(e, 'signUp', email, password, name, setErrors, handleSignUp, setIsLoading)}>
                <div className="form-group">
                    ...
                    <input
                        ...
                        value={name}
                        onChange={(e: ChangeEvent<HTMLInputElement>) => handleNameChange(e, setName, setErrors, errors)}
                        required
                    />
                ...
                <div className="form-group">
                    ...
                    <div className="password-input-container">
                        <input
                            ...
                            id="password"
                            value={password}
                            onChange={(e: ChangeEvent<HTMLInputElement>) => handlePasswordChange(e, setPassword, setPasswordStrength, setErrors, errors, 'signUp')}
                            required
                        />
                        <span

...
export default function EditProfilePage() {
      ...
      <form className='form-layout'>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={e => setProfile({ ...profile, positions: e.target.value })}
  ...
  export default function EditProfilePage() {
    ...
    const { data, error } = useFetchSingleProfile();
  
    useEffect(() => {
      if (data) {
        const fetchAvatarUrl = async () => {
          const avatarUrl = data.avatar_url ? await getAvatarUrl(data.avatar_url) : null;
